...
const NAV = [
  ...
  { section: 'MESSAGING', items: [
    ...
    { href: '/whatsapp-business',  icon: 'bi-whatsapp',              label: 'WA Business',  new: true },
    ...
    { href: '/platform-chat',      icon: 'bi-chat-left-dots-fill',   label: 'Platform Chats', new: true },
    { href: '/mobile',             icon: 'bi-android2',              label: 'DLChat PWA'          },
  ]},
  { section: 'SOCIAL MEDIA', items: [
    { href: '/social-hub',         icon: 'bi-grid-fill',             label: 'Social Hub',   new: true },
    { href: '/facebook',           icon: 'bi-facebook',              label: 'Facebook',     new: true },
    { href: '/instagram',          icon: 'bi-instagram',             label: 'Instagram',    new: true },
    { href: '/twitter',            icon: 'bi-twitter-x',             label: 'Twitter / X',  new: true },
    { href: '/tiktok',             icon: 'bi-tiktok',                label: 'TikTok',       new: true },
    { href: '/linkedin',           icon: 'bi-linkedin',              label: 'LinkedIn',     new: true },
    { href: '/snapchat',           icon: 'bi-snapchat',              label: 'Snapchat',     new: true },
    { href: '/youtube',            icon: 'bi-youtube',               label: 'YouTube',      new: true },
    { href: '/reddit',             icon: 'bi-reddit',                label: 'Reddit',       new: true },
    { href: '/discord',            icon: 'bi-discord',               label: 'Discord',      new: true },
  ]},
  { section: 'TOOLS', items: [
    { href: '/scheduler',          icon: 'bi-clock-fill',            label: 'Scheduler'           },
    { href: '/groups',             icon: 'bi-collection-fill',       label: 'Number Groups'       },
    { href: '/speed-dial',         icon: 'bi-lightning-charge-fill', label: 'Speed Dial'          },
    { href: '/pin-vault',          icon: 'bi-safe-fill',             label: 'PIN Vault'           },
    { href: '/blacklist',          icon: 'bi-slash-circle-fill',     label: 'Blacklist'           },
    { href: '/webhooks',           icon: 'bi-globe-americas',        label: 'Webhooks'            },
  ]},
